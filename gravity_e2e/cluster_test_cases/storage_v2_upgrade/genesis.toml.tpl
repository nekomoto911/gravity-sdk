# Gravity Genesis Configuration - storage_v2_upgrade (template)
# Rendered to genesis.toml by render_config.py — do not edit the rendered
# file directly. Skeleton: rolling_upgrade/genesis.toml.tpl with this
# case's dedicated validator/vfn ports (kept consistent with
# cluster.toml.tpl by a unit test).
...
# Genesis validators (node1-node4)
[[genesis_validators]]
id = "node1"
...
[genesis]
chain_id = 1337
epoch_interval_micros = 300000000  # 5 min
major_version = 1
