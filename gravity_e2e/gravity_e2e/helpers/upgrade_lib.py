"""
Pure helpers for the rolling-upgrade storage cases (storage_v2_upgrade,
storage_v2_fresh_sync).

Promoted from cluster_test_cases/storage_v2_upgrade/upgrade_lib.py — a
compatibility shim remains there — so other cases can import the recipe
as a package module. Everything here is deterministic and unit-tested in
gravity_e2e/tests/unit/test_storage_upgrade_case.py. The pytest cases keep
